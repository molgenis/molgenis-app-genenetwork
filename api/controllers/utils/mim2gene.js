...
function readMim2Gene(){
    ...
    return mim2GeneObject
        ...
        // //file mapping OMIM CUI's to gene names
        // var mim2gene = fs.readFileSync(sails.config.mim2gene, 'utf8')

        // //get OMIM CUI of specific gene
        // var mim2geneObject = {}
        // var lines = mim2gene.split('\n')
        // for (i = 0; i < mimLines.length; i++) {
        //     var mimLine = mimLines[i].split('\t')
        //     if (mimLine[1] == 'gene') {
        //         var mimGeneName = mimLine[3]
        //         mim2geneObject[mimGeneName] = mimLine[0]                        
        //     }
        // }
