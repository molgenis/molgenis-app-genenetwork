...
var Gene = React.createClass({
    ...
    render: function() {
        return (
                <div>
                <h3>Gene</h3>
                <p className='dont-break-out'><code>GET {GN.urls.external.gene}/<strong>geneName</strong></code></p>
            ...
            returned.</p>
                ...
                <h4>Examples</h4>
                <p className='dont-break-out'><code>GET {GN.urls.external.gene}/rps27l</code></p>
                <p className='dont-break-out'><code>GET {GN.urls.external.gene}/rps27l?db=GO-CC&verbose</code></p>
                </div>
        )
    }
})
...
var Term = React.createClass({
    ...
    render: function() {
        return (
                ...
                <p className='dont-break-out'><code>GET {GN.urls.external.pathway}/<strong>termId</strong></code></p>
            ...
            and an AUC (Area Under the Curve) value describing the prediction accuracy for the pathway/phenotype</li>
                ...
                <h4>Examples</h4>
                <p className='dont-break-out'><code>GET {GN.urls.external.pathway}/GO:0000302</code></p>
                <p className='dont-break-out'><code>GET {GN.urls.external.pathway}/GO:0000302?verbose</code></p>
                </div>
        )
    }
})
...
var Prioritization = React.createClass({
    ...
    render: function() {
        return (
                ...
                <p className='dont-break-out'><code>GET {GN.urls.external.prioritization}/<strong>termId1,termId2,...</strong></code></p>
                ...
                <h4>Examples</h4>
                <p className='dont-break-out'><code>GET {GN.urls.external.prioritization}/HP:0001874,HP:0001419,HP:0002718,HP:0004313,HP:0000951</code></p>
                <p className='dont-break-out'><code>GET {GN.urls.external.prioritization}/HP:0001874,HP:0001419,HP:0002718,HP:0004313,HP:0000951?verbose</code></p>
                </div>
        )
    }
})
